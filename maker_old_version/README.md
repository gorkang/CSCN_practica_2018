...
- Si se desea agregar en un texto una imagen pero no escribir ningún texto es importante que "{image:nombre_imagen.png}" se escriba entre comillas para que se reconozca que es un texto
