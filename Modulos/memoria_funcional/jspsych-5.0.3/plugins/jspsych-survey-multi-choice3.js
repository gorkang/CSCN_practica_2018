/**
 * jspsych-survey-multi-choice3
 * a jspsych plugin for multiple choice3 survey questions
 *
 * Shane Martin
 *
...
jsPsych.plugins['survey-multi-choice3'] = (function() {

  var plugin = {};

  plugin.trial = function(display_element, trial) {

    var plugin_id_name = "jspsych-survey-multi-choice3";
    ...
    // add multiple-choice3 questions
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      $(question_selector).append(
        '<p class="' + plugin_id_name + '-text survey-multi-choice3">' + trial.questions[i] + '</p>'
      );
