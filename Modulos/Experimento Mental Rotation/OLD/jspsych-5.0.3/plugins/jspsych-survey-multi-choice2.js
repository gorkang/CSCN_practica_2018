/**
 * jspsych-survey-multi-choice2
 * a jspsych plugin for multiple choice2 survey questions
 *
 * Shane Martin
 *
...
jsPsych.plugins['survey-multi-choice2'] = (function() {

  var plugin = {};

  plugin.trial = function(display_element, trial) {

    var plugin_id_name = "jspsych-survey-multi-choice2";
    ...
    // add multiple-choice2 questions
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      $(question_selector).append(
        '<p class="' + plugin_id_name + '-text survey-multi-choice2">' + trial.questions[i] + '</p>'
      );
      ...
      for (var j = 0; j < trial.options[i].length; j++) {
        ...
        $(option_id_selector + " label").prepend('<input type="radio" name="' + input_id_name + '" value="' + trial.options[i][j] + '" required>');
      }
