/**
 * jspsych-survey-multi-choicemrbeta2
...
jsPsych.plugins['survey-multi-choicemrbeta2'] = (function() {

  var plugin = {};

  plugin.trial = function(display_element, trial) {

    var plugin_id_name = "jspsych-survey-multi-choicemrbeta2";
    ...
    // add multiple-choicemrbeta2 questions
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      $(question_selector).append(
        '<p class="' + plugin_id_name + '-text survey-multi-choicemrbeta2">' + trial.questions[i] + '</p>'
      );
    ...
    $trial_form.submit(function(event) {
      ...
      $("div." + plugin_id_name + "-question").each(function(index) {
        var id = "Q" + index;
        var val = [];
        var a = $(".jspsych-survey-multi-choicemrbeta2-option");
    ...
    /* ************ TIME MOD START *********** */
    if (trial.timing_response < 0){ end_trial();}
