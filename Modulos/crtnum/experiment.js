...
var crtNum1 = {
    ...
    endword: "pesos",
    timeline: [{
            questions: ["<p class='limitnumeracy'>1. Un bate y una pelota cuestan $1.100 en total. El bate cuesta $1.000 m&aacute;s que la pelota., &iquest;Cu&aacute;nto cuesta la pelota?</p>"],
            data: {
                trialid: "LIP_01"
            }
        },
...
var crtNum2 = {
    ...
    endword: "dias",
    timeline: [{
            questions: ["<p class='limitnumeracy'>2. Si Jos&eacute; puede beber un barril de agua en 6 d&iacute;as y Mar&iacute;a puede beber un barril de agua en 12 d&iacute;as, &iquest;Cu&aacute;nto se demorar&iacute;an en tomar un barril de agua juntos?</p>"],
            data: {
                trialid: "LIP_02"
            }
        },
...
var crtNum3 = {
    ...
    endword: "minutos",
    timeline: [{
            questions: ["<p class='limitnumeracy'>3. Si 5 m&aacute;quinas demoran 5 minutos en hacer 5 aparatos., &iquest;Cu&aacute;nto tiempo se demorar&iacute;an 100 m&aacute;quinas en hacer 100 aparatos?</p>"],
            data: {
                trialid: "LIP_03"
            }
        },
...
var crtNum4 = {
    ...
    endword: "estudiantes",
    timeline: [{
            questions: ["<p class='limitnumeracy'>4. Pedro recibi&oacute; tanto la quinceava nota m&aacute;s alta como la quinceava nota m&aacute;s baja en su clase, &iquest;Cu&aacute;ntos estudiantes hay en la clase?</p>"],
            data: {
                trialid: "LIP_04"
            }
        },
...
var crtNum5 = {
    ...
    endword: "pesos",
    timeline: [{
            questions: ["<p class='limitnumeracy'>5. Un hombre compra un cerdo a $60.000, lo vende a $70.000, lo vuelve a comprar por $80.000 y finalmente lo vende por $90.000. &iquest;cu&aacute;nto ha ganado?</p>"],
            data: {
                trialid: "LIP_05"
            }
        } //,
...
var crtNum6 = {
    ...
    timeline: [{
        ...
        options: [
            ["a) No ha ganado ni perdido dinero",
                "b) Ha ganado dinero",
                "c) Ha perdido dinero"
            ]
        ]
    ...
    timeline: [
        ...
        //{questions: ["<p class='limitnumeracy'>6. Si el riesgo de padecer una enfermedad en los proximos 10 a&ntilde;os para una<br /> persona (A) es de 1% y el riesgo para otra persona (B) es el doble, &iquest;cu&aacute;l es<br /> el riesgo para la persona B?</p>"], data:{trialid: "LIP_06"}},
        {
            questions: ["<p class='limitnumeracy'>7. En un lago hay un manto de hojas de lirios. Cada d&iacute;a el manto dobla su tamaño." +
                ...
                "&iquest;cu&aacute;l es el riesgo para la persona B?</p>"
            ],
            data: {
                trialid: "LIP_06"
            }
