...
jsPsych.plugins['survey-textonly'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      focused_box = $("#jspsych-survey-textonly-" + i).append('<textarea id="id'+ i +'" autofocus required name="#jspsych-survey-textonly-response-' + i + '" cols="' + trial.columns[i] + '" rows="' + trial.rows[i] + '"></textarea>');
