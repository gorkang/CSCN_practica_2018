  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      for (var j = 0; j < trial.labels[i].length; j++) {
        options_string += '<li style="width:' + width + '%" class="modded_list" ><input id="op' + j +'" type="radio" name="Q' + i + '" value="' + j + '" onclick="lk_advance()"><label class="jspsych-survey-likert-opt-label">' + trial.labels[i][j] + '</label></li>';
        //options_string += '<li style="width:' + width + '%"><input id="op' + j +'" onclick="lk_advance()" type="radio" name="Q' + i + '" value="' + j + '"><label class="jspsych-survey-likert-opt-label">' + trial.labels[i][j] + '</label></li>';
      }
    ...
    display_element.append($('<button>', {
      ...
      'class': 'jspsych-survey-likert likertbutton'
