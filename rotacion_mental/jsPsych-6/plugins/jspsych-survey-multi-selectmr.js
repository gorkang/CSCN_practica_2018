 ...
 */
 ...
 //Check for only two answers
  var check_mrt = function(event) {
      if (($('#jspsych-survey-multi-selectmr-response-0-0').is(':checked') + $('#jspsych-survey-multi-selectmr-response-0-1').is(':checked') + $('#jspsych-survey-multi-selectmr-response-0-2').is(':checked') + $('#jspsych-survey-multi-selectmr-response-0-3').is(':checked') + $('#jspsych-survey-multi-selectmr-response-0-4').is(':checked')) == 2) {
        return true;
      }
      else {
        alert("Debes seleccionar dos alternativas");
        return false;
      }
      return false;
...
jsPsych.plugins['survey-multi-selectmr'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var cssstr = ".jspsych-survey-multi-selectmr-question { margin-top: 2em; margin-bottom: 2em; text-align: left; }"+
      ...
      ".jspsych-survey-multi-selectmr-horizontal .jspsych-survey-multi-selectmr-text {  text-align: center;}"+
