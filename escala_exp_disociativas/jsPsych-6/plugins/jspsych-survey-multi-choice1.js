...
jsPsych.plugins['survey-multi-choice1'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var cssstr = ".jspsych-survey-multi-choice1-question { margin-top: 2em; margin-bottom: 2em; text-align: left; }"+
      ...
      ".jspsych-survey-multi-choice1-horizontal .jspsych-survey-multi-choice1-option {  display: inline-block;  margin-left: 0.48em;  margin-right: 1em;  vertical-align: top; text-align: right;}"+
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      for (var j = 0; j < trial.questions[i].options.length; j++) {
        ...
        input.setAttribute('style', 'margin-left: 49%')
