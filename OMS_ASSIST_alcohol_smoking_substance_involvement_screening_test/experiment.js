...
OMS_ASSIST_alcohol_smoking_substance_involvement_screening_test = [];
...
for (var drug in drugs) {
  OMS_ASSIST_alcohol_smoking_substance_involvement_screening_test.push({
    ...
    data: {
      trialid: "OMS_ASSIST_alcohol_smoking_substance_involvement_screening_test_yes_or_no",
      drug: drug
    },
...
OMS_ASSIST_alcohol_smoking_substance_involvement_screening_test.push({
  ...
  data: {
    trialid: "OMS_ASSIST_alcohol_smoking_substance_involvement_screening_test_yes_or_no_",
    drug: "Otro"
  },
  on_finish: function(data) {
...
for (var drug in drugs) {
  school_timeline.push({
    ...
    data: {
      trialid: "OMS_ASSIST_alcohol_smoking_substance_involvement_screening_test_yes_or_no_school_",
      drug: drug
    },
    on_finish: function(data) {
      if (data.responses == '{"Q0":"No"}') {
...
school_timeline.push({
  ...
  data: {
    trialid: "OMS_ASSIST_alcohol_smoking_substance_involvement_screening_test_yes_or_no_school_" + "otros"
  },
  on_finish: function(data) {
    if (data.responses != '{"Q0":""}' && data.responses != '{"Q0":"No"}') {
      drugs[data.responses.substr(7, data.responses.length - 9)] = {
...
for (var drug in drugs) {
  main_timeline.push({
    timeline: [{
      ...
      data: {
        trialid: "OMS_ASSIST_alcohol_smoking_substance_involvement_screening_test_when_year",
        drug: drug
      }
    }],
    conditional_function: function() {
...
for (var drug in drugs) {
  main_timeline.push({
    timeline: [{
      ...
      data: {
        trialid: "OMS_ASSIST_alcohol_smoking_substance_involvement_screening_test_frequency_three_months_urge",
        drug: drug
      },
      on_finish: function(data) {
...
for (var drug in drugs) {
  timeline_4_to_6.push({
    timeline: [{
      ...
      data: {
        trialid: "OMS_ASSIST_alcohol_smoking_substance_involvement_screening_test_frequency_three_months",
        drug: drug
      },
    }],
    conditional_function: function() {
...
for (var drug in drugs) {
  main_timeline.push({
    timeline: [{
      ...
      data: {
        trialid: "OMS_ASSIST_alcohol_smoking_substance_involvement_screening_test_yes_or_no_three_months_consern",
        drug: drug
      },
    }],
    conditional_function: function() {
...
for (var drug in drugs) {
  main_timeline.push({
    timeline: [{
      ...
      data: {
        trialid: "OMS_ASSIST_alcohol_smoking_substance_involvement_screening_test_yes_or_no_three_months_stop",
        drug: drug
      },
    }],
    conditional_function: function() {
