        ...
        var check = function() {
            ...
            if (!trial.check_answers || (trial.check_answers && answers_correct))
            {
                ...
                for (i = 0; i < answers.length; i++) {
                    responses.push(["Q".concat(i.toString()),answers[i]]);
                };

                var trial_data = {
                    "question text": stripHtml(question_text),
                    "responses" : stripHtml(JSON.stringify(responses.reduce(function(p, c) { p[c[0]] = c[1]; return p; }, {})))
                };
