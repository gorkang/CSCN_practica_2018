/**
 * jspsych-survey-multi-choicemrv
...
jsPsych.plugins['survey-multi-choicemrv'] = (function() {

  var plugin = {};

  plugin.trial = function(display_element, trial) {

    var plugin_id_name = "jspsych-survey-multi-choicemrv";
    ...
    // add multiple-choicemrv questions
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      $(question_selector).append(
        '<p class="' + plugin_id_name + '-text survey-multi-choicemrv">' + trial.questions[i] + '</p>'
      );
    ...
    $trial_form.submit(function(event) {
      ...
      $("div." + plugin_id_name + "-question").each(function(index) {
        ...
        for (var j = 0; j < trial.options[index].length; j++) {
          ...
          if($('jspsych-survey-multi-choicemrv-response-'+j).is(':checked')){
        ...
        //console.log(document.getElementsByName('jspsych-survey-multi-choicemrv-response-0').checked);
        var a = $(".jspsych-survey-multi-choicemrv-option");
