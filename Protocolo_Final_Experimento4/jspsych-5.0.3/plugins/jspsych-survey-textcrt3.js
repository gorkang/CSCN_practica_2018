...
jsPsych.plugins['survey-textcrt3'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      focused_box = $("#jspsych-survey-textcrt3-" + i).append('<textarea onkeypress="advance_crt3(event)" name="#jspsych-survey-textcrt3-response-' + i + '" cols="' + trial.columns[i] + '" rows="' + trial.rows[i] + '"></textarea>');
      $("#jspsych-survey-textcrt3-" + i +" textarea").focus();
      //***************************************************************modificacion*********************************************************
      //focused_box.append($('<p class="pcrt3">dias</p>'));
      focused_box.append($('<span>&nbsp;dias</span>'));
      //***************************************************************modificacion*********************************************************
