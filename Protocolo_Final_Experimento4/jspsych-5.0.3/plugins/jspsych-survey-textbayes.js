...
jsPsych.plugins['survey-textbayes'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    */
    //v2
    display_element.append('<div class="bayesdiv1"><textarea onkeypress="tapbayes(event)" name="#jspsych-survey-textbayes-response-0" id="id1"></textarea></div>');
    display_element.append('<div class="bayesdiv2"><p>' + "de cada" + '</p></div>');
    display_element.append('<div class="bayesdiv3"><textarea onkeypress="tapbayes(event)" name="#jspsych-survey-textbayes-response-2" id="id2"></textarea></div>');
    
    //$("#jspsych-survey-textbayes-response-0").focus();
    $("#id1").focus();
