...
jsPsych.plugins['survey-text'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      focused_box = $("#jspsych-survey-text-" + i).append('<textarea onkeypress="advance_svtxt(event)" id="id'+ i +'" autofocus required name="#jspsych-survey-text-response-' + i + '" cols="' + trial.columns[i] + '" rows="' + trial.rows[i] + '"></textarea>');
