/**
 * jspsych-survey-multi-choicemath
...
jsPsych.plugins['survey-multi-choicemath'] = (function() {

  var plugin = {};

  plugin.trial = function(display_element, trial) {

    var plugin_id_name = "jspsych-survey-multi-choicemath";
    ...
    // add multiple-choice1 questions
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      $(question_selector).append(
        '<p class="' + plugin_id_name + '-text survey-multi-choicemath">' + trial.questions[i] + '</p>'
      );
