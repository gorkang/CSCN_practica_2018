/**
 * jspsych-survey-multi-choicebayes
...
jsPsych.plugins['survey-multi-choicebayes'] = (function() {

  var plugin = {};

  plugin.trial = function(display_element, trial) {

    var plugin_id_name = "jspsych-survey-multi-choicebayes";
    ...
    // add multiple-choicebayes questions
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      $(question_selector).append(
        '<p class="' + plugin_id_name + '-text survey-multi-choicebayes">' + trial.questions[i] + '</p>'
      );
