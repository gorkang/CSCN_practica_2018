...
jsPsych.plugins['survey-textnum2'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      focused_box = $("#jspsych-survey-textnum2-" + i).append('<textarea onkeypress="advance_num2(event)" id="id'+ i +'" autofocus required name="#jspsych-survey-textnum2-response-' + i + '" cols="' + trial.columns[i] + '" rows="' + trial.rows[i] + '"></textarea>');
