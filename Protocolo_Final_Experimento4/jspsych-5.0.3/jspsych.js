  ...
  function startExperiment() {
    ...
    if (fullscreen) {
      ...
      if (keyboardNotAllowed) {
        ...
        DOM_target.append('<div class="leftaligned"><p>El experimento se iniciar&aacute; a pantalla completa cuando presiones el siguiente bot&oacute;n</p><button id="jspsych-fullscreen-btn" class="jspsych-btn">Iniciar Experimento</button></div>');
