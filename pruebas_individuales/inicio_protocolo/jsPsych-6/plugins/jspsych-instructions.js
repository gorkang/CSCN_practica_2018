 ...
 */
 ...
 function showBuyNow() {
     document.getElementById("jspsych-instructions-next").style.display = "inline";
 }
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      wait_time: {
        ...
        pretty_name: 'Button label next',
        default: 0,
        description: 'Time the button needs to wait to appear.'
      }
    }
  }
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function show_current_page() {
      ...
      if (trial.show_clickable_nav) {
        ...
        nav_html += "<button id='jspsych-instructions-next' class='jspsych-btn'  style='margin-left: 5px; display: none'>"+trial.button_label_next+" &gt;</button></div>"


        display_element.innerHTML += nav_html;
        setTimeout("showBuyNow()", trial.wait_time);
