...
var graph_literacy1_a = {
    ...
    timeline: [
        /*Pregunta normal*/
        {
            ...
            questions: [{
                prompt: "<p>&iquest;Qu&eacute; porcentaje de pacientes se han recuperado tras recibir quimioterapia?</p>",
                endword: ' %',
                type: 'range',
                language: "spanish",
                range: [0,100],
...
var graph_literacy1_b = {
    ...
    timeline: [
        /*Pregunta normal*/
        {
            preamble: "<p>A continuaci&oacute;n, le presentamos informaci&oacute;n sobre varios tratamientos para el c&aacute;ncer.</p><br /><div class='centered'><img src='img/graph_1.png' /></div>",
            questions: [{
                prompt: "<p>&iquest;Qu&eacute; diferencia hay entre el porcentaje de pacientes que se ha recuperado<br /> tras recibir cirug&iacute;a y el porcentaje de paciente de pacientes que se ha recuperado<br /> tras recibir rayos X?</p>",
                required: true,
                type: 'range',
                language: "spanish",
                range: [0,100],
...
var graph_literacy2_a = {
    ...
    timeline: [
        /*Pregunta normal*/
        {
            ...
            questions: [{
                prompt: "<p>De entre todas las personas que mueren de c&aacute;ncer, aproximadamente<br /> &iquest;qu&eacute; porcentaje muere de c&aacute;ncer de pulm&oacute;n?</p>",
                required: true,
                type: 'range',
                language: "spanish",
                range: [0,100],
...
var graph_literacy2_b = {
    ...
    timeline: [
        /*Pregunta normal*/
        {
            preamble: "<p>A continuaci&oacute;n, le presentamos informaci&oacute;n sobre varios tipos de c&aacute;ncer.</p><br /><div class='centered'><img src='img/graph_2.png' /></div>",
            questions: [{
                prompt: "<p>Aproximadamente, &iquest;qu&eacute; porcentaje de personas que muere por c&aacute;ncer,<br /> fallece por c&aacute;ncer de colon, c&aacute;ncer de mama, y c&aacute;ncer de pr&oacute;stata en conjunto? </p>",
                required: true,
                language: "spanish",
                type: 'range',
                range: [0,100],
...
var gl_alt1_1 = {
    ...
    timeline: [{
        ...
        questions: [{
            prompt: "<p>Aproximadamente, &iquest;qu&eacute; porcentaje de personas sufri&oacute; Adeolitis en el a&ntilde;o 2000?</p>",
            required: true,
            type: 'range',
            language: "spanish",
            range: [0,100],
...
var gl_alt1_2 = {
    ...
    timeline: [{
        preamble: "<p>A continuaci&oacute;n, le presentamos informaci&oacute;n sobre un trastorno llamado Adeolitis.</p><br /><div class='centered'><img src='img/graph_3.png' /></div>",
        questions: [{
            prompt: "<p>&iquest;Cu&aacute;ndo se produjo un incremento mayor en el porcentaje de personas que sufre Adeolitis?",
            options: ["Entre 1975 y 1980", "Entre 2000 y 2005", "El incremento es igual en ambos intervalos", "No lo s&eacute;"],
            required: true,
            language: "spanish",
            type: 'range',
            range: [0,100],
...
var gl_alt1_3 = {
    ...
    timeline: [{
        preamble: "<p>A continuaci&oacute;n, le presentamos informaci&oacute;n sobre un trastorno llamado Adeolitis.</p><br /><div class='centered'><img src='img/graph_3.png' /></div>",
        questions: [{
            prompt: "<p>Haga una estimaci&oacute;n: &iquest;qu&eacute; porcentaje de personas sufrir&aacute; Adeolitis en el a&ntilde;o 2010?</p>",
            required: true,
            type: 'range',
            language: "spanish",
            range: [0,100],
...
var graph_literacy3_a = {
    ...
    questions: [{
        prompt: "<p>De entre los 100 pacientes con el trastorno X, &iquest;cu&aacute;ntos son mujeres?</p>",
        required: true,
        type: 'number',
        language: "spanish",
        endword: ' son mujeres.'
...
var graph_literacy3_b = {
    ...
    preamble: "<p>En la figura que aparece a continuaci&oacute;n, se representa mediante c&iacute;rculos el n&uacute;mero <br />de hombres y mujeres en un grupo de pacientes que padecen el trastorno X. <br />El n&uacute;mero total de c&iacute;rculos es 100.</p><br /><div class='centered'><img src='img/graph_4.png' /></div>",
    questions: [{
        prompt: "<p>&iquest;Cu&aacute;ntos m&aacute;s hombres que mujeres hay entre los 100 pacientes que padecen <br />el trastorno X?</p>",
        required: true,
        type: 'number',
        language: "spanish",
        endword: ' mas hombres que mujeres.'
    }],
    data: {
        trialid: "GL_04_b"
    }
...
var gl_alt2_1_1 = {
    ...
    timeline: [{
        ...
        questions: [{
            prompt: "<p>En comparaci&oacute;n con el placebo, &iquest;qu&eacute; tratamiento supone un decremento mayor <br />en el porcentaje de pacientes que fallece?</p>",
            options: ["Crosicol", "Hertinol", "Ambos son iguales", "No lo s&eacute;"],
            required: true
        }],
        data: {
            trialid: "GL_05"
...
var gl_alt2_1_2 = {
    ...
    timeline: [{
        ...
        questions: [{
            prompt: "<p>&iquest;Qu&eacute; tratamiento implica un decremento mayor en el porcentaje de pacientes enfermos?</p>",
            options: ["Apsoriatin", "Nopsorian", "Ambos son iguales", "No lo s&eacute;"],
            required: true
        }],
        data: {
            trialid: "GL_06"
...
var gl_alt2_1_3 = {
    ...
    timeline: [{
        ...
        questions: [{
            prompt: "<p>&iquest;Qu&eacute; enfermedad presenta un incremento mayor en el porcentaje de personas afectadas <br />entre 1980 y 1990?</p>",
            options: ["Coliosis", "Tiosis", "Ambas son iguales", "No lo s&eacute;"],
            required: true
        }],
        data: {
            trialid: "GL_07"
...
var graph_literacy3 = {
    ...
    questions: [{
        prompt: "<p>&iquest;Qu&eacute; porcentaje de pacientes con c&aacute;ncer fallece tras recibir quimioterapia? </p>",
        required: true,
        type: 'range',
        language: "spanish",
        range: [0,100],
...
graph_literacy_experiment = []; //timeline
