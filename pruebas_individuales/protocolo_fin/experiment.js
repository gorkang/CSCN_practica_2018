...
var screen_fin_protocolo_experiment = {
    type: 'instructions',
    ...
    on_start: function(){
        ...
        readTextFile("fin_protocolo.txt","inicio");
    }
};
...
fin_protocolo_experiment = [];    //timeline

//if the experiment isn't in fullscreen, add trial to make it fullscreen
if(window.innerWidth != screen.width || window.innerHeight != screen.height){
  fin_protocolo_experiment.push({
    type: 'fullscreen',
...
fin_protocolo_experiment.push(screen_fin_protocolo_experiment);
