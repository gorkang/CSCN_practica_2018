...
sumas.forEach(function(operacion) {
    ...
    timeline_suma.push({
        timeline: [{
            ...
            //update the timeleft and check if it produces a timeout
...
habilidad_matematica_experiment.push({
    timeline: timeline_operaciones_mixtas
})
